...
export const GALLERY_CATEGORIES: Record<GalleryCategoryKey, string> = {
  ...
  moments: "Persönliche Momente",
  transition: "Übergang in den offenen Teil",
  networking: "Networking & Gespräche",
  foodtruck: "Foodtruck Belly & Bun",
  coffeebike: "Coffee Bike",
  slush: "Slush-Eis",
  coldsofie: "Kalte Sofie",
  cupcakes: "Cupcakes",
...
export const galleryItems: GalleryItem[] = [
  ...
  { src: photoGuestFoodSmile, alt: "Lächelnder Gast mit Pulled-Beef-Fritten am Belly-&-Bun-Foodtruck", category: "networking" },
