...
const PageHero = ({ topLine, keyword, subtitle, className }: PageHeroProps) => (
  <div className={className ?? "pt-12 pb-0 px-8 max-w-7xl mx-auto mb-16"}>
    <div>
      ...
      >
        {keyword}<span className="text-foreground">.</span>
      </span>
    </div>
    <p
